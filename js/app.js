...
(function () {
  ...
  function downloadView() {
    ...
    <section class="dl-hero">
      <div class="eyebrow"><span class="pulse"></span> Slaak.gg launcher · v1.0.7 · Windows 10/11</div>
      ...
      <div class="dl-cards">
        <div class="dl-card" id="dlSetup">
          ...
          <div class="dl-card-meta">
            <span>slaakgg-setup-1.0.7.exe</span>
            <span>78.3 MB</span>
          </div>
          <a class="btn btn-primary dl-card-btn" href="/downloads/slaakgg-setup-1.0.7.exe" download>Download setup</a>
        </div>
        <div class="dl-card" id="dlPortable">
          ...
          <div class="dl-card-meta">
            <span>slaakgg-portable-1.0.7.exe</span>
            <span>77.9 MB</span>
          </div>
          <a class="btn btn-ghost dl-card-btn" href="/downloads/slaakgg-portable-1.0.7.exe" download>Download portable</a>
        </div>
      </div>
    </section>
    <section class="section">
